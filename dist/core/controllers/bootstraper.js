...
var bootstraper = 'https://fantasy.premierleague.com/drf/bootstrap-static';
/**
 *
 */
exports.fplBootstrap = new lib_1.Route('/bootstrap/static', {
    get: { callback: getCb }
});
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    res.json({
                        teams: data.teams,
                        events: data.events.map(function (event) { return ({
                            name: event.name,
