...
var controllers_1 = require("api/auth/controllers");
var lib_1 = require("api/lib");
var auth_1 = require("api/auth");
var logger = lib_1.masterLogger.getLogger('auth', 'module');
var url = '/auth';
var routes = [controllers_1.register, controllers_1.login];
/**
 * @module auth
 ...
 * - Authorization
 */
exports.auth = new lib_1.MetaposModule(function (metapos) { return __awaiter(_this, void 0, void 0, function () {
    var router;
    return __generator(this, function (_a) {
        logger.verbose('Adding authenticator to api');
        metapos.apiRouter.use(auth_1.authenticator);
        logger.verbose('Creating router');
        router = express_1.Router();
        logger.verbose('Adding routes to auth router');
        routes.forEach(function (r) { return (r.router = router); });
        logger.verbose('Adding routes to api router');
        controllers_1.users.router = metapos.apiRouter;
